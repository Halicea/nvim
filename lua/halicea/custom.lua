...
vim.cmd([[ command! ShowWinBar :lua ShowWinBar() ]])
function ShowWinBar()
	WinbarActive = true
...
vim.cmd([[ command! HideWinBar :lua HideWinBar() ]])
function HideWinBar()
	WinbarActive = false
	vim.opt.winbar = ""
	vim.opt.statusline = ""
...
vim.cmd([[ command! ToggleWinBar :lua ToggleWinBar() ]])
...
vim.cmd([[ command! CopyBufferPath :lua CopyBufferPath() ]])
